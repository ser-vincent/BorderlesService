        ...
        <nav class="navbar navbar-expand-lg custom_nav-container text-center mx-auto w-75">
          ...
          <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/user/aboutPage">About</a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="/services/acquistaServizi">Acquista servizi</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/services/offriServizio">Offri servizi</a>
              </li>
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class="dropdown-item" href="/services/preferiti"><i class="fa-solid fa-heart"></i> Preferiti</a></li>
