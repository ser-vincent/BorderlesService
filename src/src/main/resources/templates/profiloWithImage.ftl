            ...
            <div class="col-lg-4">
              <div class="card mb-4">
                <div class="card-body text-center">
                  ...
                  <img src="/user/displayProfile?id=${utente.id}" alt="avatar"
                    class="img1 rounded-circle img-fluid" style="width: 150px; height: 150px; border: 5px solid rgb(88, 146, 255); border-radius: 50%;">
